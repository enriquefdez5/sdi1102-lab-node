module.exports = function (app, gestorBD) {
    ...
    app.post("/api/cancion", function (req, res) {
        ...
        //TODO
        // ¿Validar nombre, genero, precio? Hacer una validación seria
        if (cancion.nombre == null || cancion.nombre.length >= 20
            || cancion.genero == null || cancion.precio == null || cancion.precio <= 0) {

            res.status(400);
            res.json({error: "Error de sintaxis"})
        } else {
